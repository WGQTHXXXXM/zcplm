        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'visible' => $searchModel->zc_part_number_toggle == 1,
                ],
                //一供料号
                [
                    ...
                    "contentOptions" => ['style'=>'overflow: hidden;text-overflow: ellipsis;white-space:nowrap;'],
                    'visible' => $searchModel->mfr_part_number_toggle == 1,
                ],
                [
                    'attribute' => 'part_name',
                    'value' => 'part_name',
                    ...
                    "contentOptions" => ['style'=>'overflow: hidden;text-overflow: ellipsis;white-space:nowrap;'],
                    'visible' => $searchModel->part_name_toggle == 1,
                ],
                [
                    ...
                    'headerOptions'=>['width'=>'100px'],
                    "contentOptions" => ['style'=>'overflow: hidden;text-overflow: ellipsis;white-space:nowrap;'],
                    'visible' => $searchModel->car_number_toggle == 1,
                ],
                //  'description',
                [
                    ...
                    "contentOptions" => ['style'=>'overflow: hidden;text-overflow: ellipsis;white-space:nowrap;'],
                    'visible' => $searchModel->description_toggle == 1,
                ],
                [
                    'attribute' => 'unit',
                    'value' => 'unit',
                    'visible' => $searchModel->unit_toggle == 1,
                ],
                //一供厂家
                [
                    'attribute' => 'mfr1',
                    ...
                    'visible' => $searchModel->manufacturer_toggle == 1,
                ],
                //二供
                [
                    ...
                    'visible' => $searchModel->manufacturer2_id_toggle == 1,
                ],
                //三供
                [
                    ...
                    'visible' => $searchModel->manufacturer3_id_toggle == 1,
                ],
                //四供
                [
                    ...
                    'visible' => $searchModel->manufacturer4_id_toggle == 1,
                ],
                //  '采购等级',
                [
                    'attribute' => 'purchase_level',
                    'value' => 'purchase_level',
                    'visible' => $searchModel->purchase_level_toggle == 1,
                ],
                //规格书
                [
                    'attribute' => 'datasheet',
                    ...
                    'visible' => $searchModel->datasheet_toggle == 1,
                ],
                ...
                [
                    ...
                    'headerOptions'=>['width'=>'100px'],
                    "contentOptions" => ['style'=>'overflow: hidden;text-overflow: ellipsis;white-space:nowrap;'],
                    'visible' => $searchModel->pcb_footprint_toggle == 1,
                ],
                //更新时间
                [
                    ...
                    'visible' => $searchModel->date_entered_toggle == 1,
                ],
                //物料级别
                [
                    ...
                    'visible' => $searchModel->vehicle_standard_toggle == 1,
                ],
                //零件类型
                [
                    'attribute' => 'partType1',
                    ...
                    'visible' => $searchModel->part_type_toggle == 1,
                ],
                //零件大小值
                [
                    'attribute' => 'value',
                    'value' => 'value',
                    'visible' => $searchModel->value_toggle == 1,
                ],
                //零件原理图
                [
                    'attribute' => 'schematic_part',
                    'value' => 'schematic_part',
                    'visible' => $searchModel->schematic_part_toggle == 1,
                ],
                //采购推荐等级
                [
                    ...
                    "filterInputOptions" => ['style'=>"width: 90px",'class'=>'form-control'],//让列宽为90
                    'visible' => $searchModel->recommend_purchase_toggle == 1,
                ],
                [
                    'attribute' => 'remark',
                    'value' => 'remark',
                    'headerOptions'=>['width'=>'100px'],
                    "contentOptions" => ['style'=>'overflow: hidden;text-overflow: ellipsis;white-space:nowrap;'],
                    'visible' => $searchModel->remark_toggle == 1,
                ],
            ],
        ]); ?>
    </div>
